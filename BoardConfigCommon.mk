...
# HACK: Modules built from kernel 5.10 are larger than on 5.4,
# causing recovery.img to exceed the default partition size.
# Increase it temporarily until a proper fix is available.
