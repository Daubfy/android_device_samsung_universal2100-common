...
#define VTS_TRICAP_DEVICE_NODE         20
#define VTS_RECORD_DEVICE_NODE         21

#ifndef MMAP_INTERFACE_ENABLED
/* sysfs file paths for loading model binaries into VTS kernel driver */
#define VTS_HOTWORD_MODEL           "/sys/devices/platform/15510000.vts/vts_google_model"
#define VTS_SVOICE_MODEL            "/sys/devices/platform/15510000.vts/vts_svoice_model"
#endif
/* Google model binary size is used, as this is greater then SVoice model size */
#define VTSDRV_MISC_MODEL_BIN_MAXSZ             0x10800

#define AUDIO_PRIMARY_HAL_LIBRARY_PATH "/vendor/lib/libaudioproxy2.so"
...
#define HEADSET_MIC_CONTROL_COUNT       10 // original 8
